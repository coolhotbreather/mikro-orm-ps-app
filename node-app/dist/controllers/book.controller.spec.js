...
describe('BookController', () => {
    ...
    beforeAll(async () => {
        ...
        const author = server_2.DI.authors.create({
            name: 'Test Author',
            email: 'test.author@example.com',
            createdAt: new Date(),
            updatedAt: new Date(),
        });
        await server_2.DI.orm.em.persistAndFlush(author);
        // Сохраняем ID автора
        authorId = author.id;
    });
    afterAll(async () => {
        ...
        // DI.server.close();
        await server_2.DI.em.nativeDelete(entities_1.Book, {});
        await server_2.DI.em.nativeDelete(entities_1.Author, {});
    });
